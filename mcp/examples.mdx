...
```
Turn this week's blog post into a 7-slide Instagram carousel.
```

The agent writes the slide text and calls `draft_carousel`, then gives you a link. It opens the draft in Sydium with the Carousel Studio showing the slides in your brand's style - adjust them there and schedule. The agent never publishes a carousel it cannot see.
