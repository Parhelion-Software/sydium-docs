...
<ParamField body="coverAlternatives" type="string[]" required>
  Exactly two other cover hooks, different from the first slide's headline and from each other. The user picks one of the three in the studio.
</ParamField>
